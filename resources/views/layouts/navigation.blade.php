<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-dropdown align="left" width="48">
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('settings.openrouter.index')">
                                {{ __('OpenRouter API') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('stores.index')">
                                {{ __('Stores') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('prompt-templates.index')">
                                {{ __('AI Prompts') }}
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('custom-endpoints.index')" :active="request()->routeIs('custom-endpoints.*')">
                {{ __('Custom Endpoints') }}
            </x-responsive-nav-link>
            <div class="px-4 py-2 text-xs font-semibold text-gray-500 uppercase tracking-wider">{{ __('Settings') }}</div>
