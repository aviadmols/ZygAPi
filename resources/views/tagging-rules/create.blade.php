        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <p class="mb-4 text-sm text-gray-600">לצורך יצירת חוקיות מורכבות עם AI, השתמש ב-<a href="{{ route('ai-conversations.create') }}" class="text-blue-600">ממשק השיחה עם AI</a></p>
