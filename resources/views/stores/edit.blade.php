                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('stores.update', $store) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="shopify_store_url" id="shopify_store_url" value="{{ old('shopify_store_url', $store->shopify_store_url) }}" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="shopify_access_token" id="shopify_access_token" value="{{ old('shopify_access_token', $store->shopify_access_token) }}" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
